...
from modules.services.user_service import build_user_from_access_entries, parse_user_access_dataframe
...
class AuthorizationService:
    ...
    def authorize(self, email: str | None, *, fallback_name: str | None = None) -> User | None:
        ...
        if not active_entries:
            return None
        return build_user_from_access_entries(active_entries, fallback_name=fallback_name)
